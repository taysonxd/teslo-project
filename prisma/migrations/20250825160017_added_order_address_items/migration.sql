-- AlterTable
ALTER TABLE "public"."ProductImage" ADD CONSTRAINT "ProductImage_pkey" PRIMARY KEY ("id");

-- DropIndex
DROP INDEX "public"."ProductImage_id_key";

-- AlterTable
ALTER TABLE "public"."UserAddress" ADD CONSTRAINT "UserAddress_pkey" PRIMARY KEY ("id");

-- DropIndex
DROP INDEX "public"."UserAddress_id_key";
