                            ...
                            <li key={index} className="page-item">
                                <Link
                                    className={clsx(
                                        ...
                                        {
                                            'bg-transparent text-gray-800 hover:text-gray-800 hover:bg-gray-200 focus:shadow-none': currentPage !== page,
                                            'bg-blue-600 text-white hover:text-white hover:bg-blue-600 shadow-md focus:shadow-md': currentPage === page
                                        }
                                    )}
                                ...
                                >
                                    { page }
                                    {
                                        currentPage == page && (<span className="visually-hidden"></span>)
                                    }
                                </Link>
                            </li>
                        ))
